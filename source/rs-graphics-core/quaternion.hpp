...
namespace RS::Graphics::Core {
    ...
    public:
        ...
        std::string str(const RS::Format::FormatSpec& spec = {}) const { return "H" + RS::Format::format_range(*this, spec); }
...
namespace std {
    ...
    template <typename T>
    struct hash<RS::Graphics::Core::Quaternion<T>> {
        size_t operator()(const RS::Graphics::Core::Quaternion<T>& q) const noexcept { return q.hash(); }
    };
